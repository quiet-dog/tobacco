        ...
        <MyTable>
            ...
            <template #table>
                <ElTable v-loading="loadingTable" element-loading-text="正在加载中" empty-text="暂无案件" size="large"
                    ...
                    <el-table-column width="100" prop="party" label="当事人" show-overflow-tooltip>
                        <template #default="scope">
                    ...
                    <el-table-column width="120" prop="storage_time" label="入库时间" show-overflow-tooltip>
                        <template #default="scope">
                            <span>{{ scope.row.storage_time ? formatDate(scope.row.storage_time) : "-" }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="120" prop="out_storage_time" label="出库时间" show-overflow-tooltip>
                        <template #default="scope">
                            <span>{{ scope.row.out_storage_time ? formatDate(scope.row.out_storage_time) : "-" }}</span>
                        </template>
                    </el-table-column>
                        ...
                        <div>
                            <div style="height: 450px;">
                                <el-table max-height="100%" height="100%" :data="tableData2"
                                    ...
                                    <el-table-column prop="storager" label="出库人" show-overflow-tooltip>
                                    </el-table-column>
