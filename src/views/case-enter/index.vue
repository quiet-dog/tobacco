        ...
        <MyTable>
            ...
            <template #table>
                <ElTable v-loading="loadingTable" element-loading-text="正在加载中" empty-text="暂无案件"
                    ...
                    <el-table-column fixed width="100" prop="report_code" label="报告编号" show-overflow-tooltip>
                    ...
                    <el-table-column width="120" p prop="party" label="当事人" show-overflow-tooltip>
                        <template #default="scope">
                            <span v-html="highText(scope.row.party, searchValue)"></span>
                        </template>
                    </el-table-column>
                    <el-table-column width="120" p prop="value" label="案值（元）" show-overflow-tooltip>
                        <template #default="scope">
                    ...
                    <el-table-column width="200" pprop="sampling_time" label="抽样时间" show-overflow-tooltip>
                        <template #default="scope">
                            <span>{{ scope.row.sampling_time ? formatDate(scope.row.sampling_time) : "-" }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="100" p prop="sampler" label="抽样人" show-overflow-tooltip />
                    <el-table-column width="200" p prop="sampling_site" label="抽样地点" show-overflow-tooltip>
                        <template #default="scope">
...
import { formatDate, formatDate2, highText, baseUrl, expressCompanies } from "@/utils"
